...
`define OPCODE_J_JAL       7'b1110011;
`define OPCODE_I_JALR      7'b1100011;
...
// FUNCT3
`define FUNCT3_ADD       3'h0; // ADD vs SUB -> funct7
`define FUNCT3_XOR       3'h4;
`define FUNCT3_OR        3'h6;
`define FUNCT3_AND       3'h7;
`define FUNCT3_SLL       3'h1;
`define FUNCT3_SR        3'h5; // Arithmetic vs logical -> funct7
`define FUNCT3_SLT       3'h2;
`define FUNCT3_SLTU      3'h3;


// FUNCT7 (DUAL ARGUMENT)
`define FUNCT7_SUB       7'h20; // Subtract
`define FUNCT7_SRA       7'h20; // Shift right arithmetic (0 -> logical shift)

// FUNCT7 (IMMEDIATE)
`define FUNCT7_SLLI_IMM_MASK 12'b0; // value h(5:11) = 0x0 of the immediate
`define FUNCT7_SRLI_IMM_MASK 12'b0; // value h(5:11) = 0x0 of the immediate
`define FUNCT7_SRAI_IMM_MASK 12'b1000_0000_0000; // value h(5:11) = 0x20 of the immediate
